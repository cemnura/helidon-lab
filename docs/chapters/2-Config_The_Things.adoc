...
Helidon will automatically get configurable values as in YAML configuration.


==== GIT Config

Version controlling the web server config can be a good idea. This will
enable you to change the server configuration with just simple commit push to a remote repository.
